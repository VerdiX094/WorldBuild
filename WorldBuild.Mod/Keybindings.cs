...
namespace WorldBuild.Mod
{
    public class Keybindings : ModKeybindings
    {
        ...
        {
            AddOnKeyDown_World(Place, BuildManager.main.TryBuildPart);
            
            AddOnKeyDown_World(Delete, BuildManager.main.DestroyHeldPart);
            ...
            AddOnKeyDown_World(FlipHorizontally, () =>
            {
                ...
                Utility.ScalePart(BuildManager.main.heldPart, new Vector2(-1f, 1f));
            });
